...
export default function BannerItem(props: BannerItemProps){
    ...
    return(
        ...
        <div className="border-b-2 transform duration-300 hover:border-primary">
            <div onClick={()=>props.onClick(props.index)} className="flex items-center justify-between cursor-pointer">
