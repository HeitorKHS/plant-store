import { IconMapPinFilled, IconPhoneFilled, IconBrandWhatsappFilled, IconMailFilled, IconBrandInstagram, IconBrandFacebook, IconBrandYoutube, IconBrandGooglePlay, IconBrandAppstore } from "@tabler/icons-react";
...
export default function Footer(){
    ...
    return(
        ...
        <div className="mt-20 bg-[#E8E8E4]">
            <div className="py-10 grid sm:grid-cols-2 lg:grid-cols-4 justify-items-center gap-10 lg:gap-0">
